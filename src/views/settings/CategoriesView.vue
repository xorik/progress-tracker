...
import {useCategoriesSettings} from "../../composables/use-settings";

const {categories, editCategory, createCategory, deleteCategory} = useCategoriesSettings()
</script>
<template>
  <div class="flex">
  ...
  <div v-for="c in categories" class="flex items-center gap-2 my-2">
